...
The following tools will help you throughout this workshop, helping you write, execute, and code effectively. Select the appropriate option for your operating system, follow the installation instructions, and dive into the world of coding with confidence!
...
Also, once you've finished **installation Steps 1 and 2**, fill out the [Installation Check-In form](https://forms.gle/Y6Yi9HTZSjD1MPHb7). 
<!-- and the [CS1010  form](https://forms.gle/EoKoGY5KHMi4wEBs7). Both the forms are **MANDATORY** to be filled out before the first class.Entry -->

### You will be automatically entered into a raffle in the workshop on 10/12/2024.
