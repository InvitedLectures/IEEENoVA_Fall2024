...
:::{.callout-important}
 - Follow the instructions provided carefully and complete the required installations needed for this workshop. 
 - Once you finish the **Steps 1, 2 and 3 in the installation instructions**, fill out the [Installation Check-In form](https://forms.gle/Y6Yi9HTZSjD1MPHb7). 
